...
class AnswerGeneratorTest {
    ...
    void shouldFindAnswerForVerticalDownOnMiddle() {
        ...
        Answer answer = new AnswerGenerator(wordService).generateAnswer(new Question(Position.of(4, 2), Orientation.VERTICAL, Arrow.DOWN_ON_MIDDLE), 5).orElseThrow();
    ...
    void shouldFindAnswerForHorizontal() {
        ...
        Answer answer = new AnswerGenerator(wordService).generateAnswer(new Question(Position.of(4, 2), Orientation.HORIZONTAL, Arrow.RIGHT_ON_MIDDLE), 5).orElseThrow();
